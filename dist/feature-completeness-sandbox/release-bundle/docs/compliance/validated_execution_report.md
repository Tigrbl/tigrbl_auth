...
- validated_manifests: `['dist/validated-runs/migration-portability-py313.json', 'dist/validated-runs/test-conformance-py311.json', 'dist/validated-runs/test-core-py311.json', 'dist/validated-runs/test-core-py312.json', 'dist/validated-runs/test-integration-py311.json', 'dist/validated-runs/test-interop-py311.json', 'dist/validated-runs/test-security-negative-py311.json', 'dist/validated-runs/tier3-evidence-py313.json']`
...
- recognized_manifest_paths: `['dist/validated-runs/migration-portability-py313.json', 'dist/validated-runs/test-conformance-py311.json', 'dist/validated-runs/test-conformance-py313.json', 'dist/validated-runs/test-core-py311.json', 'dist/validated-runs/test-core-py312.json', 'dist/validated-runs/test-core-py313.json', 'dist/validated-runs/test-integration-py311.json', 'dist/validated-runs/test-integration-py313.json', 'dist/validated-runs/test-interop-py311.json', 'dist/validated-runs/test-interop-py313.json', 'dist/validated-runs/test-security-negative-py311.json', 'dist/validated-runs/test-security-negative-py313.json', 'dist/validated-runs/tier3-evidence-py313.json']`
- ignored_json_paths: `[]`
