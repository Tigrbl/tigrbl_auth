...
- peer_profile: `client-mgmt`
- counterpart_id: `client-mgmt-harness`
- required_targets: `RFC 7591, RFC 7592`
- scenario_ids: `client-register, client-read-update-delete, client-registration-access-token`
...
- required_artifacts: `http-transcript.yaml, client-metadata.json, result.yaml`
