...
- peer_profile: `par-jar-rar`
- counterpart_id: `par-jar-rar-client`
- required_targets: `RFC 9101, RFC 9126, RFC 9396, RFC 8707`
- scenario_ids: `par-submit, jar-authorize, rar-authorize, rar-resource-binding`
...
- required_artifacts: `http-transcript.yaml, request-objects/, result.yaml`
