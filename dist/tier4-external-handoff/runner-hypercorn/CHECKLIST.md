...
- peer_profile: `runner-hypercorn`
- counterpart_id: `hypercorn-runner`
- required_targets: `ASGI 3 application package, Runner profile: Hypercorn`
- scenario_ids: `runner-launch, runner-health, runner-contract-hash`
...
- required_artifacts: `http-transcript.yaml, result.yaml`
