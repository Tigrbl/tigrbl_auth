...
- peer_profile: `dpop`
- counterpart_id: `dpop-client`
- required_targets: `RFC 9449, RFC 9700`
- scenario_ids: `dpop-token, dpop-replay-rejection, dpop-nonce-recovery`
...
- required_artifacts: `http-transcript.yaml, proof-jwts.json, result.yaml`
