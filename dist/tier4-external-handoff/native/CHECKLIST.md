...
- peer_profile: `native`
- counterpart_id: `native-client`
- required_targets: `RFC 7636, RFC 8252, RFC 7516, RFC 9207`
- scenario_ids: `native-loopback, native-custom-scheme, native-jwe-id-token, native-issuer-parameter`
...
- required_artifacts: `http-transcript.yaml, stdout.log, result.yaml`
