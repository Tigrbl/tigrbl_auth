...
1. Identify the independent external counterpart `native-client` and the operator who ran it.
2. Capture the exact commands, image/container digest, runtime details, and environment used for peer profile `native`.
