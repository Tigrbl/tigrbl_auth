...
- peer_profile: `rp-session-logout`
- counterpart_id: `rp-session-logout-rp`
- required_targets: `RFC 6265, OIDC Session Management, OIDC RP-Initiated Logout, OIDC Front-Channel Logout, OIDC Back-Channel Logout`
- scenario_ids: `session-state-check, rp-initiated-logout, frontchannel-fanout, backchannel-delivery, cookie-rotation-and-replay`
...
- required_artifacts: `http-transcript.yaml, browser-trace.json, logout-tokens.json, result.yaml`
