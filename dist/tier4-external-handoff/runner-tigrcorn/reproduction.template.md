...
1. Identify the independent external counterpart `tigrcorn-runner` and the operator who ran it.
2. Capture the exact commands, image/container digest, runtime details, and environment used for peer profile `runner-tigrcorn`.
