...
- peer_profile: `resource-server`
- counterpart_id: `resource-server`
- required_targets: `RFC 6750, RFC 7662, RFC 8693, RFC 8707, RFC 9068, RFC 9728, RFC 9700`
- scenario_ids: `bearer-resource, introspection-resource, jwt-access-token-resource, token-exchange-resource, resource-indicator-binding, hardening-protected-resource-metadata`
...
- expected_execution_style: `black-box-http`
...
- required_artifacts: `http-transcript.yaml, resource-response.log, result.yaml`
