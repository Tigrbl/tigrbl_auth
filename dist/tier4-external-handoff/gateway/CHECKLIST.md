...
- peer_profile: `gateway`
- counterpart_id: `gateway-peer`
- required_targets: `RFC 6750, RFC 8414, RFC 8615, RFC 7517, RFC 9700, RFC 9728, OIDC Discovery 1.0`
- scenario_ids: `gateway-discovery, gateway-jwks, gateway-protected-resource, gateway-hardening-discovery-truthfulness`
...
- required_artifacts: `http-transcript.yaml, gateway-config.yaml, result.yaml`
