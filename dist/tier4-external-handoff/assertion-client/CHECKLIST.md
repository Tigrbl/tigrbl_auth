...
- peer_profile: `assertion-client`
- counterpart_id: `assertion-client-harness`
- required_targets: `RFC 7515, RFC 7517, RFC 7518, RFC 7519, RFC 7521, RFC 7523, RFC 7009`
- scenario_ids: `jwt-client-auth, assertion-grant, jwt-bearer-claim-validation, token-revocation, jwks-key-selection`
...
- required_artifacts: `http-transcript.yaml, jwt-assertions.json, result.yaml`
