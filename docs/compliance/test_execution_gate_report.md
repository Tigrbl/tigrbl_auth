...
- classification_failures: `['Unclassified test files present: tests/unit/test_phase13_truthfulness_alignment.py, tests/unit/test_phase6_migration_portability_evidence.py']`
