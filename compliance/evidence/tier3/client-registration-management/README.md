...
Bearer-authenticated read/update/delete registration management with durable client-registration metadata and operator/RPC parity through the shared service layer.
