...
- tier3_ready_targets: `['OIDC Core 1.0', 'OIDC Discovery 1.0', 'OIDC UserInfo', 'OpenAPI 3.1 / 3.2 compatible public contract', 'OpenRPC 1.4.x admin/control-plane contract', 'RFC 6265', 'RFC 6749', 'RFC 6750', 'RFC 7009', 'RFC 7515', 'RFC 7516', 'RFC 7517', 'RFC 7518', 'RFC 7519', 'RFC 7521', 'RFC 7523', 'RFC 7591', 'RFC 7636', 'RFC 7662', 'RFC 8252', 'RFC 8414', 'RFC 8615', 'RFC 9068', 'RFC 9728']`
- tier4_ready_targets: `[]`
