...
1. Use the staged external-root fixture directory `dist/tier4-external-root-fixtures/2026-03-25/par-jar-rar`.
2. Verify the counterpart metadata for `par-jar-rar-client` and inspect the preserved artifacts.
