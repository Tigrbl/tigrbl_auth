...
1. Use the staged external-root fixture directory `dist/tier4-external-root-fixtures/2026-03-25/device`.
2. Verify the counterpart metadata for `device-client` and inspect the preserved artifacts.
