...
1. Use the staged external-root fixture directory `dist/tier4-external-root-fixtures/2026-03-25/spa`.
2. Verify the counterpart metadata for `spa-rp` and inspect the preserved artifacts.
