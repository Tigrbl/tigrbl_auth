...
def test_uvicorn_runner_profile_can_launch_dummy_asgi_application() -> None:
    adapter = get_runner_adapter("uvicorn")
    if not adapter.is_available():
        pytest.skip("uvicorn is not installed in this environment")
    ...
    assert any(meta.name == "host" for meta in adapter.flag_metadata)
